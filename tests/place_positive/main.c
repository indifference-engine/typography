...
int main(const int argc, const char *const *const argv)
{
  ...
  if (!write_text_int(73207300, &font_a, 0.1564262168f, 0.0437286089f, 0.2452098142f, 0.4578030974f, &written))
  {
  ...
  assert_int("placed glyphs", 8, placed.number_of_placed_glyphs);
  ...
  assert_int("placed glyph index a", 4, placed_glyph_indices[0]);
  assert_int("placed glyph index b", 9, placed_glyph_indices[1]);
  assert_int("placed glyph index c", 5, placed_glyph_indices[2]);
  assert_int("placed glyph index d", 12, placed_glyph_indices[3]);
  assert_int("placed glyph index e", 4, placed_glyph_indices[4]);
  assert_int("placed glyph index f", 9, placed_glyph_indices[5]);
  assert_int("placed glyph index g", 12, placed_glyph_indices[6]);
  assert_int("placed glyph index h", 12, placed_glyph_indices[7]);

  assert_int("placed glyph row a", 997, placed_glyph_rows[0]);
  ...
  assert_int("placed glyph row e", 997, placed_glyph_rows[4]);
  assert_int("placed glyph row f", 1009, placed_glyph_rows[5]);
  assert_int("placed glyph row g", 1011, placed_glyph_rows[6]);
  assert_int("placed glyph row h", 1011, placed_glyph_rows[7]);

  assert_int("placed glyph column a", -2000, placed_glyph_columns[0]);
  assert_int("placed glyph column b", -1983, placed_glyph_columns[1]);
  assert_int("placed glyph column c", -1972, placed_glyph_columns[2]);
  assert_int("placed glyph column d", -1922, placed_glyph_columns[3]);
  assert_int("placed glyph column e", -1908, placed_glyph_columns[4]);
  assert_int("placed glyph column f", -1891, placed_glyph_columns[5]);
  assert_int("placed glyph column g", -1880, placed_glyph_columns[6]);
  assert_int("placed glyph column h", -1866, placed_glyph_columns[7]);
  ...
  assert_float("placed glyph opacity h", 0.1564262168f, placed_glyph_opacities[7]);
  ...
  assert_float("placed glyph red h", 0.0437286089f, placed_glyph_reds[7]);
  ...
  assert_float("placed glyph green h", 0.2452098142f, placed_glyph_greens[7]);
  ...
  assert_float("placed glyph blue h", 0.4578030974f, placed_glyph_blues[7]);
