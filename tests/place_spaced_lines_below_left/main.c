...
int main(const int argc, const char *const *const argv)
{
  ...
  assert_int("placed glyph row a", 131, placed_glyph_rows[0]);
  assert_int("placed glyph row b", 126, placed_glyph_rows[1]);
  assert_int("placed glyph row c", 126, placed_glyph_rows[2]);
  assert_int("placed glyph row d", 210, placed_glyph_rows[3]);
  assert_int("placed glyph row e", 215, placed_glyph_rows[4]);
  assert_int("placed glyph row f", 215, placed_glyph_rows[5]);
  assert_int("placed glyph row g", 252, placed_glyph_rows[6]);
  assert_int("placed glyph row h", 252, placed_glyph_rows[7]);
  assert_int("placed glyph row i", 312, placed_glyph_rows[8]);
  assert_int("placed glyph row j", 349, placed_glyph_rows[9]);
  assert_int("placed glyph row k", 354, placed_glyph_rows[10]);
