...
int main(const int argc, const char *const *const argv)
{
  ...
  const int glyph_widths_a[] = {23, 18, 19, 25, 12, 45, 8, 9, 2, 6, 11, 9, 3, 5};
  ...
  const int glyph_row_offsets_a[] = {5, -7, 8, 2, -3, 8, 10, -5, 7, 9, 2, 11, -4, 5};
  ...
  assert_int("placed glyph index b", 5, placed_glyph_indices[1]);
  assert_int("placed glyph index c", 11, placed_glyph_indices[2]);
  assert_int("placed glyph index d", 4, placed_glyph_indices[3]);
  assert_int("placed glyph index e", 9, placed_glyph_indices[4]);
  assert_int("placed glyph index f", 11, placed_glyph_indices[5]);
  assert_int("placed glyph index g", 11, placed_glyph_indices[6]);

  assert_int("placed glyph row a", 1009, placed_glyph_rows[0]);
  assert_int("placed glyph row b", 1008, placed_glyph_rows[1]);
  assert_int("placed glyph row c", 1011, placed_glyph_rows[2]);
  assert_int("placed glyph row d", 997, placed_glyph_rows[3]);
  ...
  assert_int("placed glyph column b", -1989, placed_glyph_columns[1]);
  assert_int("placed glyph column c", -1939, placed_glyph_columns[2]);
  assert_int("placed glyph column d", -1925, placed_glyph_columns[3]);
  assert_int("placed glyph column e", -1908, placed_glyph_columns[4]);
  assert_int("placed glyph column f", -1897, placed_glyph_columns[5]);
  assert_int("placed glyph column g", -1883, placed_glyph_columns[6]);
