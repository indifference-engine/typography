...
int main(const int argc, const char *const *const argv)
{
  ...
  const text_font *placed_text_fonts[5];
  int placed_glyph_indices[5];
  int placed_glyph_rows[5];
  int placed_glyph_columns[5];
  float placed_glyph_opacities[5];
  float placed_glyph_reds[5];
  float placed_glyph_greens[5];
  float placed_glyph_blues[5];
  placed_text placed = {
      .number_of_placeable_glyphs = 5,
