...
int main(const int argc, const char *const *const argv)
{
  ...
  assert_int("placed glyph index a", 10, placed_glyph_indices[0]);
  ...
  assert_int("placed glyph column f", -1895, placed_glyph_columns[5]);
  assert_int("placed glyph column g", -1884, placed_glyph_columns[6]);
  assert_int("placed glyph column h", -1870, placed_glyph_columns[7]);
