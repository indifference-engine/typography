...
int main(const int argc, const char *const *const argv)
{
  ...
  const int number_of_placed_glyphs = place_text(written, ABOVE_TEXT_ANCHOR, LEFT_OF_TEXT_ANCHOR, &placed);
  ...
  assert_int("placed glyph row a", -445, placed_glyph_rows[0]);
  assert_int("placed glyph row b", -450, placed_glyph_rows[1]);
  assert_int("placed glyph row c", -450, placed_glyph_rows[2]);
  assert_int("placed glyph row d", -366, placed_glyph_rows[3]);
  assert_int("placed glyph row e", -361, placed_glyph_rows[4]);
  assert_int("placed glyph row f", -361, placed_glyph_rows[5]);
  assert_int("placed glyph row g", -324, placed_glyph_rows[6]);
  assert_int("placed glyph row h", -324, placed_glyph_rows[7]);
  assert_int("placed glyph row i", -264, placed_glyph_rows[8]);
  assert_int("placed glyph row j", -227, placed_glyph_rows[9]);
  assert_int("placed glyph row k", -222, placed_glyph_rows[10]);
