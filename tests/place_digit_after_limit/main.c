...
int main(const int argc, const char *const *const argv)
{
  ...
  if (write_text_int(-3207300, &font_a, 0.4108292209f, 0.5393818291f, 0.3282327683f, 0.1319314262f, &written))
  {
  ...
  assert_int("placed glyph index a", 7, placed_glyph_indices[0]);
  ...
  assert_int("placed glyph index e", 10, placed_glyph_indices[4]);
  assert_int("placed glyph index f", 9, placed_glyph_indices[5]);

  assert_int("placed glyph row a", 1000, placed_glyph_rows[0]);
  ...
  assert_int("placed glyph row e", 1050, placed_glyph_rows[4]);
  assert_int("placed glyph row f", 1056, placed_glyph_rows[5]);

  assert_int("placed glyph column a", -2000, placed_glyph_columns[0]);
  assert_int("placed glyph column b", -1950, placed_glyph_columns[1]);
  assert_int("placed glyph column c", -1860, placed_glyph_columns[2]);
  assert_int("placed glyph column d", -2000, placed_glyph_columns[3]);
  assert_int("placed glyph column e", -1922, placed_glyph_columns[4]);
  assert_int("placed glyph column f", -1909, placed_glyph_columns[5]);
  ...
  assert_float("placed glyph opacity e", 0.4108292209f, placed_glyph_opacities[4]);
  assert_float("placed glyph opacity f", 0.4108292209f, placed_glyph_opacities[5]);
  ...
  assert_float("placed glyph red e", 0.5393818291f, placed_glyph_reds[4]);
  assert_float("placed glyph red f", 0.5393818291f, placed_glyph_reds[5]);
  ...
  assert_float("placed glyph green e", 0.3282327683f, placed_glyph_greens[4]);
  assert_float("placed glyph green f", 0.3282327683f, placed_glyph_greens[5]);
  ...
  assert_float("placed glyph blue e", 0.1319314262f, placed_glyph_blues[4]);
  assert_float("placed glyph blue f", 0.1319314262f, placed_glyph_blues[5]);
